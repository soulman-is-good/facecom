...
class UserProfile extends Record {
    ...
    public function rules() {
        return array(
            ...
            array('activities, interests, music, quotes, about', 'safe'),
    ...
    public function getUserProfile($id) {
        return $this->find(
            array(
                ...
                'select' => 'user_id, first_name, second_name, third_name, avatar, background', 
                'params' => array(
                    ':id' => $id
                )
            )
    ...
    public function afterFind() {
        if (empty($this->background) || !is_file('upload/UserProfile/' . $this->background)) {
            $this->background = 'userTestBG.png';
        }

        if (empty($this->avatar) || !is_file('upload/UserProfile/' . $this->avatar)) {
            $this->avatar = 'testAvatar.png';
        }
