...
class University extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, place_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'place' => array(self::BELONGS_TO, 'Placemarks', 'place_id'),
			'userUniversities' => array(self::HAS_MANY, 'UserUniversity', 'university_id'),
		);
	}
