 ...
 * @property User $user
 */
class UserFriendRequests extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return UserFriendRequests the static model class
	 */
	...
	public function getFriendsRequests($user_id) {
		return $this->findAll(
            array(
            	'condition' => 'user_id=:id AND t.status=3', 
                'with'=>'invited',
                'limit' => 6,
                'group' => 'friend_id',
                'params' => array(
	...
	public function getFriendsRequestsCount($user_id) {
		return $this->findAll(
            array(
            	'condition' => 'user_id=:id AND t.status=3', 
                'with'=>'invited',
	...
	public function getFriendsRequestsPage($user_id) {
		return $this->findAll(
            array(
            	'condition' => 'user_id=:id AND t.status=3', 
                'with'=>'invited',
