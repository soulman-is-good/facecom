...
<div class="form">
    <div class="field">
        ...
        <?php echo CHtml::dropDownList('country_id', $country_id,$countries,array('class'=>'country_id','for'=>'#city_id','fcselect'=>"")); ?>
    </div>
    <div class="field">
    ...
    <div class="field">
        ...
        <?php echo $form->dropDownList($model, 'gender', UserProfile::model()->getGenderInfo(2),array('fcselect'=>"")); ?>
        <?php echo $form->error($model, 'gender'); ?>
    </div>
    <div class="field">
        <?php echo $form->label($model, 'family'); ?>
        <?php echo $form->dropDownList($model, 'family', $states[$model->gender],array('fcselect'=>"")); ?>
