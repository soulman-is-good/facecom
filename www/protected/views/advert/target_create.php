<div class="content">
	<table cellspacing="0" cellpadding="0" class="advertContent">
		<tr>
			<td class="mainblock2">
              	<h1>Создание объявления<span id="h2" style="display:none;"> - Шаг 2 Целевая аудитория</span></h1>
              	...
              	<form action="/advert/target/run" method="post" name="interview" id="interviewForm" onSubmit="return validate();">
              	<div id="step1" facecom="tab">
              	<a name="step1"></a>
              	<table border="0" cellspacing="7" cellpadding="0" class="defTable">
              		<tr>
              			<td align="right" valign="center" class="label">
              				<label for="name">Служебное название объявления</label>
              			</td>
              		...
              		<tr>
              			<td align="right" valign="center" class="label">
              				<label for="mtext">Текст объявления</label>
              			</td>
              				<td align="left" valign="center" class="value"><textarea name="mtext" id="mtext" placeholder="Введите текст"></textarea></td>
              			</td>
              		</tr>
              	</table>
              	</div>
